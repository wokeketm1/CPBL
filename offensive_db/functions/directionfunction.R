...
direction[grep("[穿][越][一][二][壘]",x)]="右"
direction[grep("[穿][越][二][三][壘]",x)]="左"
direction[grep("[穿][越][游][擊]",x)]="左"
direction[grep("[穿][越][二][游]",x)]="左"
direction[grep("[穿][越][三][游]",x)]="左"
direction[grep("[穿][越][一][壘]",x)]="右"
direction[grep("[穿][越][二][壘]",x)]="中"
direction[grep("[穿][越][三][壘]",x)]="左"
direction[grep("[一][壘][線][邊][穿][越]",x)]="右"
direction[grep("[三][壘][線][邊][穿][越]",x)]="左"
direction[grep("[犧][牲][觸][擊]",x)]="內"
direction[grep("[一][壘][防][區][穿][越]",x)]="右"
direction[grep("[二][壘][防][區][穿][越]",x)]="中"
direction[grep("[游][擊][防][區][穿][越]",x)]="左"
direction[grep("[三][壘][防][區][穿][越]",x)]="左"
direction[grep("[三][游][間][穿][越]",x)]="左"
direction[grep("[三][游][穿][越]",x)]="左"
direction[grep("[二][游][間][穿][越]",x)]="左"
direction[grep("[二][游][穿][越]",x)]="左"
